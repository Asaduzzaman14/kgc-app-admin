    ...
    const getBanners = async () => {
        try {
            const response = await axios.get(
                'https://kgc-app.vercel.app/api/v1/banner',
                {
                    headers: {
                        Authorization: `${token}`,
            ...
            if (result.isConfirmed) {
                try {
                    const response = await axios.delete(
                        `https://kgc-app.vercel.app/api/v1/banner/${id}`,
                        {
                            headers: {
                                Authorization: token,
                                'Content-Type': 'application/json',
                            ...
                            {banner?.map((banner: any, key: any) => (
                                <tr key={key}>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <img className='w-27 h-25' src={banner.img} alt="" />
                                    </td>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-3 dark:border-strokedark">
                                        <div className="flex items-center space-x-3.5">
                                            ...
                                            {/* delete  */}
                                            <button
                                                onClick={() => deleteServices(banner?._id)}
